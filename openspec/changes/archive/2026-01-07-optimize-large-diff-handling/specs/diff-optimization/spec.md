...
```
jj-desc generate [OPTIONS]

Options:
  -x, --exclude <PATTERN>  Files to exclude from diff (can be repeated)
  --dry-run                Preview without applying
  -r, --revision <REV>     Target revision
...
```
jj-desc backfill [OPTIONS]

Options:
  -x, --exclude <PATTERN>  Files to exclude from diff (can be repeated)
  --dry-run                Preview without applying
  -r, --revisions <REVSET> Target revisions
  -n, --limit <N>          Max commits to process
  -i, --interactive        Confirm each description
  -h, --help               Print help
```
